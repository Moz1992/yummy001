...
export const customProducts: Product[] = [
  {
    id: 'magsafe-case',
    name: 'YY004 | MagSafe透明磁吸手机壳',
    name_en: 'MagSafe Clear Magnetic Phone Case',
    description: '适用于iPhone 15 Pro Max的MagSafe透明磁吸手机壳。透明PC塑料材质，轻薄便携，防摔保护，精准开孔，不发黄。',
    price: 4900,
    image_url: '/images/magsafe-case-1.jpg',
    stone_type: '手机壳',
